kotlin
// RitualPatternsManager.kt
package com.antonio.my.ai.girlfriend.free.rituals
...
class PhaseXIIManager private constructor(private val context: Context) {
    ...
    fun isInitialized(): Boolean {
        return _initializationState.value == InitializationState.Initialized
    }
    ...
    fun getInitializationError(): String? {
        ...
        return if (state is InitializationState.Error) state.message else null
    }
